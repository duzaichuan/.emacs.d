(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-pdfview writeroom-mode org-bullets matlab-mode org org-edna 0blayout pdf-tools tao-theme ob-ipython smartparens company auto-package-update polymode pandoc-mode auctex)))
