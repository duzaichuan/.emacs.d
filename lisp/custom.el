...
(custom-set-faces
 ...
 '(w3m-arrived-anchor ((t (:foreground "azure4" :underline t))))
 '(w3m-current-anchor ((t (:background "gray38" :foreground "#FCFCFC" :underline nil :weight bold))))
 '(w3m-header-line-location-content ((t (:background "gray94" :foreground "gray40" :underline nil :weight normal))))
 '(w3m-header-line-location-title ((t (:background "gray94" :foreground "dark cyan" :underline nil :weight semi-bold))))
 '(w3m-tab-background ((t (:background "dark gray" :foreground "#FCFCFC" :underline nil :weight normal))))
 ...
 '(w3m-tab-selected-background ((t (:background "dark gray" :foreground "black"))))
 '(w3m-tab-selected-retrieving ((t (:background "gray40" :foreground "#FCFCFC" :underline nil :weight bold))))
 '(w3m-tab-unselected ((t (:background "dark gray" :foreground "gray40" :box (:line-width 2 :color "dark gray")))))
 '(w3m-tab-unselected-retrieving ((t (:background "gray50" :foreground "#FCFCFC" :underline nil :weight normal)))))
